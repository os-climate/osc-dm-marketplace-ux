...
const DashboardAdministratorComponent = () => {
    ...
    const uxSuccess = () => {
        return(
            <Container maxWidth="xl">
                <Typography variant="h1" gutterBottom>Administrator Dashboard</Typography>
...
export default DashboardAdministratorComponent;
